    ...
    <div class="vx-navbar-wrapper navbar-full p-0">
      <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses" :style="navbarStyle"
        ...
        <router-link tag="div" to="/" class="vx-logo cursor-pointer mx-auto flex items-center">
          ...
          <span class="vx-logo-text text-primary">La fabrique du Pere Noel</span>
        </router-link>
...
export default {
  ...
  computed: {
    ...
    navbarClasses() {
      return this.scrollY > 5 && this.navbarType === 'static' ? '' : 'd-theme-dark-light-bg shadow-none'
    },
    scrollY() {
