  ...
  <div id="invoice-page">
    ...
    <div class="flex flex-wrap items-center justify-between">
      ...
      <div class="flex items-center">
        ...
        <vs-button class="mb-base mr-3" icon-pack="feather" icon="icon icon-file" @click="printInvoice">Print
        </vs-button>
      </div>
    </div>
    ...
    <vx-card id="invoice-container">
      ...
      <div class="invoice__footer text-right p-base">
        <p class="mb-4">Transfer the amounts to the business amount below. Please include invoice number on your
          check.</p>
        <p>
