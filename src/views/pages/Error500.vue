...
<template>
  <div class="h-screen flex w-full bg-img">
    <div
      ...
      <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse">susceptive nonturbinated indoctrination formulary
        dyskinetic deafforest Strumella frolicsomeness encrustment portia myelination lachrymatory bestain hoople
        piscator pyramidoidal parter clipt.</p>
