            ...
            <template>
                <div v-if="Object.keys(pronostic).length !== 0" class="vx-row">
                        ...
                        <div ref="matchCard">
                            <vx-card slot="no-body" :class="themeMode?'':'bg-primary-gradient'"
                                ...
                                <vs-row vs-align="center"
                                        ...
                                        v-if="pronostic.rencontres.length===1">
                                    <vs-col class=" w-1/5">
                                        <img
                                ...
                                <h3 class="mb-6 text-white"><strong>{{ pronostic.pourcentage_de_mise }}% de
                                    mise</strong>
                                </h3>
                    ...
                    <div v-if="isSmallerScreen" class="vx-col w-full text-center" style="margin-top: -50px">
                        <div class="vx-col w-full">
                            ...
                            <vs-button href="https://www.instagram.com/foxsportif.fr/" type="gradient"
                    ...
                    <div v-else class="vx-col w-full text-center ">
                        <div class="vx-col w-full">
                            ...
                            <vs-button href="https://www.instagram.com/foxsportif.fr/" target type="gradient"
                                       class="mr-1 ml-1 mt-0"
                                       style=" display: inline-flex" icon-pack="feather"
                                       icon="icon-instagram">
                                Instagram
                ...
                <div v-else-if="!loading" class="vx-row">
                    ...
                    <div class="vx-col w-full text-center">
                        <div class="vx-col w-full">
                            <vs-button href="https://t.me/FoxSportif" target class="mr-1 ml-1 mt-0"
                                       style=" display: inline-flex"
                                       icon-pack="feather" icon="icon-send">
                                Telegram
                            </vs-button>
